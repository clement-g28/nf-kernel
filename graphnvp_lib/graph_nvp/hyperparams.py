...
class Hyperparameters:
    def __init__(self, num_gcn_layer=3, num_nodes=-1, num_relations=-1, num_features=-1, masks=None, path=None,
                 ...
                 mlp_channels=None, gnn_channels=None, seed=1, use_switch=False):
        # Added
